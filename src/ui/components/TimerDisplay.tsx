...
export function TimerDisplay({ timeRemaining }: TimerDisplayProps) {
  ...
  return (
    <div className={cn("transition-colors", isOvertime ? "text-red-500" : "text-white")}>
      <div className="font-mono tabular-nums relative inline-block text-[8rem] sm:text-[12rem] md:text-[16rem] lg:text-[20rem] leading-none font-bold tracking-tighter">
        {isOvertime && (
          <span
            aria-hidden="true"
